...
app.title = 'Covid19 - Global Dashboard '
...
##############################################################################################################################
# Moving India to the first row in the datatable (You can choose any country of interest to be display on the first row)
##############################################################################################################################
...
#############################################################################
mapbox_access_token = 'pk.eyJ1IjoicHJhdGhhbWVzaHAxMzIxIiwiYSI6ImNrb3ZqZTI5YjA1dDUycHRtam5va3JheXYifQ.ka4KRPG9NzcNYGjX87qUNQ'
...
app.layout = html.Div(
    ...
    html.Div([
        ...
        html.Div(
            [
                html.H1(children='Covid-19(Corona-Virus) Interactive Outbreak Tracker',
                        style={
                            'textAlign': 'left',
                            'color': colors['text'],
                ...
                html.Div([html.Span('Outbreak since Jan-2020: ',
                             style={'color': colors['text'],
                             }),
                ...
                html.Div(children='Refresh browser for latest update.',
                         style={
                             'textAlign': 'left',
                             'color': colors['text'],
                             'backgroundColor': colors['background'],
        ...
        # Creating Nav bar with dark theme
        ...
        html.Div([
            ...
            html.Div(
                    [
                        html.Hr(),
                        html.P(' Pillai HOC College Of Engineering And Technology,Rasayani. ',
                               style={'display': 'inline','fontweight':'bold','position':'bottom','textalign':'centre','color':'white','fontSize': 28}),
                        html.P(' Developed by SEIT Students ',
                               style={'fontweight':'bold','textalign':'left','position':'bottom','textalign':'centre','color':'grey','fontSize': 24}),
                        html.P('Covid 19 Version 2.0 Web App',
                               style={'fontweight':'italic','textalign':'right','position':'bottom','textalign':'centre','color':'orange','fontSize': 20}),
                        html.Hr(),
                    ], className="twelve columns",
